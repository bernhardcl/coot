...
#include "ccp4mg-utils/mmut/mmut_connectivity.h"
#include "ccp4mg-utils/mmut/mman_manager.h"
#include "ccp4mg-utils/mmut/splineinfo.h"
#include "ccp4mg-utils/mmut/atom_util.h"
 
#include "ccp4mg-utils/pygl/cbuild.h"
#include "ccp4mg-utils/pygl/cdisplayobject.h"

#include "ccp4mg-utils/util/CParamsManager.h"

#include "ccp4mg-utils/mgapp/mg_colour.h"
...
//   }
  ...
  molHnd = new mmdb::Manager();
  g_print("BL DEBUG:: reading file %s\n", name_.c_str());
  molHnd = atom_sel.mol;
  int selHnd = molHnd->NewSelection();

  molHnd->SelectAtoms(selHnd, 0,"*",mmdb::ANY_RES,"*",mmdb::ANY_RES,"*","*","*","*","*",mmdb::SKEY_OR );
