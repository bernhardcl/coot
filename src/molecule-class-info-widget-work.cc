...
molecule_class_info_t::fill_symmetry_control_frame(GtkWidget *symmetry_controller_dialog) const {
   ...
   g_object_ref (vbox168);
   g_object_set_data_full (G_OBJECT (symmetry_controller_dialog), "vbox168", vbox168,
              (GDestroyNotify) g_object_unref);
   ...
   g_object_ref (molecule_0_checkbutton);
   ...
   g_object_ref (frame162);
   g_object_set_data_full (G_OBJECT (symmetry_controller_dialog), "frame162", frame162,
              (GDestroyNotify) g_object_unref);
   ...
   g_object_ref (table4);
   g_object_set_data_full (G_OBJECT (symmetry_controller_dialog), "table4", table4,
              (GDestroyNotify) g_object_unref);
   ...
   g_object_ref (display_sphere_radiobutton_molecule_0);
   ...
   g_object_ref (display_all_radiobutton_molecule_0);
   ...
   g_object_ref (display_CA_radiobutton_molecule_0);
   ...
   g_object_ref (colour_symm_std_molecule_0);
   ...
   g_object_ref (colour_symm_by_symop_molecule_0);
   ...
   g_object_ref (colour_symm_by_molecule_molecule_0);
   ...
   g_signal_connect (G_OBJECT (display_all_radiobutton_molecule_0), "toggled",
             G_CALLBACK (on_display_all_radiobutton_molecule_0_toggled),
		       GINT_TO_POINTER(imol_no));
   g_signal_connect (GTK_OBJECT (display_CA_radiobutton_molecule_0), "toggled",
...
molecule_class_info_t::fill_ncs_control_frame_internal(GtkWidget *ncs_control_dialog) const {
   ...
   g_object_ref (vbox176);
   g_object_set_data_full (G_OBJECT (ncs_control_dialog), "vbox176", vbox176,
              (GDestroyNotify) g_object_unref);
   ...
   g_object_ref (ncs_controller_molecule_n_display_ncs_checkbutton);
   ...
   g_object_ref (hseparator11);
   g_object_set_data_full (G_OBJECT (ncs_control_dialog), "hseparator11", hseparator11,
              (GDestroyNotify) g_object_unref);
   gtk_widget_show (hseparator11);
   gtk_box_pack_start (GTK_BOX (vbox176), hseparator11, TRUE, TRUE, 2);

   hbox134 = gtk_hbox_new (FALSE, 0);
   g_object_ref (hbox134);
   g_object_set_data_full (G_OBJECT (ncs_control_dialog), "hbox134", hbox134,
              (GDestroyNotify) g_object_unref);
   gtk_widget_show (hbox134);
   gtk_box_pack_start (GTK_BOX (vbox176), hbox134, TRUE, TRUE, 0);

   vbox172 = gtk_vbox_new (FALSE, 0);
   g_object_ref (vbox172);
   g_object_set_data_full (G_OBJECT (ncs_control_dialog), "vbox172", vbox172,
              (GDestroyNotify) g_object_unref);
   gtk_widget_show (vbox172);
   gtk_box_pack_start (GTK_BOX (hbox134), vbox172, TRUE, TRUE, 0);

   label264 = gtk_label_new (_("Displayed Chains"));
   g_object_ref (label264);
   g_object_set_data_full (G_OBJECT (ncs_control_dialog), "label264", label264,
              (GDestroyNotify) g_object_unref);
   ...
   g_object_ref (ncs_controller_molecule_n_display_chain_vbox);
   g_object_set_data_full (G_OBJECT (ncs_control_dialog),
   ...
   for (int ich=0; ich<n_chains; ich++) {
	 ...
	 gtk_check_button_new_with_label (label.c_str());
      g_object_ref (ncs_controller_molecule_n_display_chain_ich_checkbutton);
      ...
      gtk_box_pack_start (GTK_BOX (ncs_controller_molecule_n_display_chain_vbox),
		       ncs_controller_molecule_n_display_chain_ich_checkbutton,
			  FALSE, FALSE, 0);
      gtk_widget_set_tooltip_text(ncs_controller_molecule_n_display_chain_ich_checkbutton,
             _("Show this chain as a ghost chain?"));
   ...
   g_object_ref (vbox174);
   g_object_set_data_full (G_OBJECT (ncs_control_dialog), "vbox174", vbox174,
              (GDestroyNotify) g_object_unref);
   gtk_widget_show (vbox174);
   gtk_box_pack_start (GTK_BOX (hbox134), vbox174, TRUE, TRUE, 0);

   label265 = gtk_label_new (_("NCS Master Chain"));
   g_object_ref (label265);
   g_object_set_data_full (G_OBJECT (ncs_control_dialog), "label265", label265,
              (GDestroyNotify) g_object_unref);
   ...
   g_object_ref (ncs_controller_molecule_n_vbox);
   g_object_set_data_full (G_OBJECT (ncs_control_dialog),
   ...
   for (int ich=0; ich<n_chains; ich++) {
    ...
    gtk_radio_button_get_group (GTK_RADIO_BUTTON (ncs_controller_ncs_master_chain_ich_radiobutton));
      g_object_ref (ncs_controller_ncs_master_chain_ich_radiobutton);
      ...
      gtk_widget_set_tooltip_text (ncs_controller_ncs_master_chain_ich_radiobutton,
             _("The chain to which operators and ghosts are generated from other chains"));
