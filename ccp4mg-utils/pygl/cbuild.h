...
enum { BONDS, CYLINDERS, SPHERES, BALLSTICK, SPLINE, WORM, FATWORM, FATBONDS, THINBONDS, NUCLEICBASEPAIRS, PYRAMIDS, LIPIDS, ANISOU, CIRCLES, IMPOSTER_SPHERES, VARIABLEWORM, BLOB_ELLIPSOIDS, SUGAR_BLOCKS, POINTS_SPHERES };
...
void DrawSugarBlocks(Displayobject &obj, CMMANManager *molHnd, int selHnd, mmdb::Atom** selAtoms, int nSelAtoms, const AtomColourVector &atom_colour_vector, const CParamsManager &params, const CParamsManager &global_params, double *hb_params_array=NULL);

void DrawAnisoU(Displayobject &obj, int selHndin, mmdb::Atom** selAtoms, int nSelAtoms, const AtomColourVector &atom_colour_vector, const std::vector<double> &atomRadii,int style, double scale,const CParamsManager &global_params);
...
void DrawBlobEllipsoids(Displayobject &obj,int selHnd, const Connectivity &connectivity, const AtomColourVector &atom_colour_vector, const CParamsManager &params, const CParamsManager &global_params);
