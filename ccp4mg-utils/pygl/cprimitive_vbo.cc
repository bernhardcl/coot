...
std::string Primitive::GetPrimitiveTypeAsString(void) const {
  if(polygonType == GL_POINTS){
    return std::string("POINTS");
  }
  if(polygonType == GL_LINES){
    return std::string("LINES");
  }
  if(polygonType == GL_LINE_STRIP){
    return std::string("LINE_STRIP");
  }
  if(polygonType == GL_LINE_LOOP){
    return std::string("LINE_LOOP");
  }
  if(polygonType == GL_TRIANGLES){
  ...
  if(polygonType == GL_QUADS){
    return std::string("QUADS");
  }
  if(polygonType == GL_QUAD_STRIP){
    return std::string("QUAD_STRIP");
  }
  if(polygonType == GL_POLYGON){
