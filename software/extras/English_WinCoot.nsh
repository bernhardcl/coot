...
!insertmacro LANGFILE "English_WinCoot" "English_WinCoot"
...
!ifdef MUI_UNDIRECTORYSPAGE
  ...
  ${LangFileString} MUI_UNTEXT_DIRECTORY_SUBTITLE "Choose the folder from which to uninstall $(^NameDA). Please try to avoid SPACES in the directory name."
!endif
